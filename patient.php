...
if(isset($_POST[submit]))
{
	...
	{
		$sql ="INSERT INTO patient(typeofcare,patientname,admissiondate,admissiontime,address,mobileno,city,pincode,loginid,password,bloodgroup,gender,dob,status) values('$_POST[typeofcare]','$_POST[patientname]','$dt','$tim','$_POST[address]','$_POST[mobilenumber]','$_POST[city]','$_POST[pincode]','$_POST[loginid]','$_POST[password]','$_POST[select2]','$_POST[select3]','$_POST[dateofbirth]','Active')";
		if($qsql = mysqli_query($con,$sql))
		{
    ...
    <div class="card">
        ...
        <form method="post" action="" name="frmpatient" onSubmit="return validateform()" style="padding: 10px">
            ...
            <div class="form-group">
              <label for="sel1">Patient's Admission Type:</label>
              <select class="form-control" id="sel1" name="typeofcare">
                <option value="inpatient" selected> Inpatient Care </option>
