...
<div class="container-fluid">
	<div class="block-header" style="display:flex;justify-content: space-between;">
            <h2>Patient Report Panel</h2>
             <a href="patientprintout.php?patientid=<?php echo $_GET['patientid'].'&appointmentid='.$_GET['appointmentid'];?>" class="btn btn-info text-white btn-sm" title="My Report">Print &nbsp;&nbsp;
